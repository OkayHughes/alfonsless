...
derivative_matrix = vector_derivative(1, intParams.mon_basis);
probData.A = sparse([-eye(intParams.U); -intParams.mon_to_P0 * derivative_matrix * intParams.P0_to_mon]');
mon_con1 = msspoly(1);
mon_con1_vec = intParams.mon_to_P0 * msspoly_to_vector(mon_con1, intParams.mon_basis);
probData.c = [zeros(intParams.U, 1); mon_con1_vec];
probData.b = -[intParams.w];
